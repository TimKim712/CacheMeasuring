...
1. Spin up the local instances for Postgres and Redis with `docker-compose up -d`. Postgres should be on `localhost:5432` and Redis should be on `localhost:6379`.
